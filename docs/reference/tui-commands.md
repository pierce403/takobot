...
- `explore`, `explore <topic>` (manual exploration tick; auto-selects a mission-aligned topic when omitted, bypasses normal poll windows, and avoids immediate auto-topic repeats)
- `web <url>`, `run <command>`
